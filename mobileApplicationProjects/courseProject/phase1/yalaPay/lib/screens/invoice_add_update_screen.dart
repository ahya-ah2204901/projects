...
class _InvoiceAddUpdateScreenState
  ...
  void initState() {
    ...
    if (widget.invoiceId != '-1') {
      final invoiceProvider = ref.read(invoiceNotifierProvider);
      final existingInvoice = invoiceProvider.firstWhere(
        (invoice) => invoice.id == widget.invoiceId,
      );

      selectedCustomerName = existingInvoice.customerName;
      amountController.text = existingInvoice.amount.toString();
      dueDateController.text =
          "${existingInvoice.dueDate?.year}-${existingInvoice.dueDate?.month.toString().padLeft(2, '0')}-${existingInvoice.dueDate?.day.toString().padLeft(2, '0')}";
            ...
            children: [
              ...
              if (widget.invoiceId == '-1')
                DropdownButtonFormField<String>(
                  ...
                  items: customerProvider.map((customer) {
                        ...
                        showDialog(
                            ...
                            builder: (context) => AlertDialog(
                                  ...
                                  actions: [
                                    ...
                                    TextButton(
                                      onPressed: () {
                                        invoiceNotifier.addUpdateInvoice(
                                            id: widget.invoiceId,
