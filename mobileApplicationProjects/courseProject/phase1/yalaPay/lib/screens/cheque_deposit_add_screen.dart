...
class _ChequeDepsoitAddScreenState
  ...
  void initState() {
    ...
    selectedCheques = List<bool>.filled(awaitingCheques.length, false);
          ...
          child:
            ...
            Padding(
              ...
              child: DropdownButtonFormField<String>(
                value:
                    selectedBankAccount.isNotEmpty ? selectedBankAccount : null,
                decoration: const InputDecoration(
                      ...
                      subtitle: RichText(
                        text: TextSpan(
                          ...
                          children: [
                            ...
                            TextSpan(
                              text: Cheque.getBankString(
                                  awaitingCheques[index].bankName),
                            ),
                          ],
                        ),
                      ),
