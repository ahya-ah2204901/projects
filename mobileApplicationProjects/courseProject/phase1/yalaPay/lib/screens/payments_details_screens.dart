...
class _PaymentDetailsScreenState extends ConsumerState<PaymentDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final payment = payments.firstWhere((pay) => pay.id == widget.paymentId);
    return Scaffold(
      appBar: AppBar(
        leading: IconButton(
          onPressed: () {
              ...
              child: Card(
                child: Padding(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      _buildDetailColumn("Invoice No.", payment.invoiceNo),
                      _buildDetailColumn("Amount", payment.amount.toString()),
